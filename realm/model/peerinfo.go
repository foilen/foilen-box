...
// Hostname and Description are the peer's self-reported identity info,
// fetched automatically whenever the peer connects (see Engine.onConnected);
// they are not preserved across an Upsert (e.g. a fresh discovery
// callback), only set via Store.SetHostnameDescription.
